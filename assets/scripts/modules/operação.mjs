...
export let tabuada_estatica = tabuadas.tab_add
...
export function chose(){
    ...
    switch(valor){
        ...
        case 'Adição':
            ...
            operador = '-'
            tabuada_estatica = tabuadas.tab_sub
        ...
        case 'Subtração':
            ...
            operador = '%'
            tabuada_estatica = tabuadas.tab_div
        break

        case 'Divisão':
            buttonE1.textContent = 'Multiplicação'
            operador = 'x'
            tabuada_estatica = tabuadas.tab_mult
        break

        case 'Multiplicação':
            buttonE1.textContent = 'Adição'
            operador = '+'
            tabuada_estatica = tabuadas.tab_add
        break
